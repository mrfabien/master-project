...
way = "C:/Users/fabau/Downloads/"

for i in month_act:
        var = 'ERA5_' + year + '-' + str(i) + '_' + folder
        locals()['dew_point_xr_' + str(i)] = xr.open_dataset(way+var+'.nc')
        
for i in month_next:
    next_var = 'ERA5_' + year_next +'-' + str(i) + '_' + folder
    locals()['dew_point_xr_' + str(i)] = xr.open_dataset(way+next_var+'.nc')
...
dates = pd.read_csv('C:/Users/fabau/OneDrive/Documents/GitHub/master-project/tracks_square_storm/storms_start_end.csv', sep=',')
...
for i in range(index_start_october,index_end_march):
    locals()['track_' + str(i+1)] = pd.read_csv('C:/Users/fabau/OneDrive/Documents/GitHub/master-project/tracks_square_storm/tc_irad_tracks/tc_1_hour/tc_irad_' + str(i+1) + '_interp.txt')   
...
for j in range (index_start_october,index_end_march+1):
    track_temp = pd.read_csv(f'C:/Users/fabau/OneDrive/Documents/GitHub/master-project/tracks_square_storm/tc_irad_tracks/tc_1_hour/tc_irad_' + str(j+1) + '_interp.txt')
...
for j in range(index_start_october,index_end_march+1):
    ...
    locals()[f"mean_out_{j+1}"].to_csv(f'C:/Users/fabau/OneDrive/Documents/GitHub/master-project/datasets/{folder}/storm_{j+1}/mean_{j+1}.csv')
    locals()[f"min_out_{j+1}"].to_csv(f'C:/Users/fabau/OneDrive/Documents/GitHub/master-project/datasets/{folder}/storm_{j+1}/min_{j+1}.csv')
    locals()[f"max_out_{j+1}"].to_csv(f'C:/Users/fabau/OneDrive/Documents/GitHub/master-project/datasets/{folder}/storm_{j+1}/max_{j+1}.csv')
    locals()[f"sigma_out_{j+1}"].to_csv(f'C:/Users/fabau/OneDrive/Documents/GitHub/master-project/datasets/{folder}/storm_{j+1}/sigma_{j+1}.csv')
